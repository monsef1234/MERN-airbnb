...
const Header = () => {
  ...
  return (
    <header className="p-4 flex items-center justify-between">
      <Link to="/" className="flex items-center gap-1 divide-x">
        <svg
      ...
      <div className="user flex items-center border border-gray-500 shadow-md shadow-gray-300 rounded-full px-2 py-1 gap-2">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
        ...
        <span className="capitalize text-primary font-normal">
          {member?.name}
        </span>
        <Link
          to={member ? "/account" : "/login"}
          className="bg-gray-500 border border-gray-500 rounded-full text-white"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
